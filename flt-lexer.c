...
keywords[] = {
        ...
        [FLT_LEXER_KEYWORD_X2] = "x2",
        [FLT_LEXER_KEYWORD_Y2] = "y2",
        [FLT_LEXER_KEYWORD_X3] = "x3",
        [FLT_LEXER_KEYWORD_Y3] = "y3",
        [FLT_LEXER_KEYWORD_X4] = "x4",
        [FLT_LEXER_KEYWORD_Y4] = "y4",
        [FLT_LEXER_KEYWORD_STROKE_WIDTH] = "stroke_width",
        [FLT_LEXER_KEYWORD_T] = "t",
        [FLT_LEXER_KEYWORD_COLOR] = "color",
        ...
        [FLT_LEXER_KEYWORD_DIAL] = "dial",
        [FLT_LEXER_KEYWORD_NEEDLE] = "needle",
        [FLT_LEXER_KEYWORD_WIDTH] = "width",
